...
const ChartLegendContent = forwardRef<HTMLDivElement, ChartLegendContentProps>((props, ref) => {
  const { className, hideIcon = false, payload, verticalAlign = 'bottom', nameKey, colorBoxClassName } = props;
  const { config } = useChart();
        ...
        return (
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                className={cn('h-2 w-2 shrink-0 rounded-[2px]', colorBoxClassName)}
                style={{
