...
import { CurrentStepProps } from '.';

export const PromotionVisualizationModal = styled(Modal)<{
  ...
  ${({ step }) => css`
    min-width: ${step === '1' ? '80rem' : '117.4rem'};
  `}
...
export const ContentWrapper = styled.div<{ step: CurrentStepProps }>`
  width: 100%;
